...
func TestDeploymentASAT(t *testing.T) {
	...
	for _, result := range results {
		if result.name == "fakeDeploymentASAT1" && (result.err != ErrorServiceAccountTokenDeprecated || result.dsa == "") {
...
func TestStatefulSetASAT(t *testing.T) {
	...
	for _, result := range results {
		if result.name == "fakeStatefulSetASAT1" && (result.err != ErrorServiceAccountTokenDeprecated || result.dsa == "") {
...
func TestDaemonSetASAT(t *testing.T) {
	...
	for _, result := range results {
		if result.name == "fakeDaemonSetASAT1" && (result.err != ErrorServiceAccountTokenDeprecated || result.dsa == "") {
...
func TestPodASAT(t *testing.T) {
	...
	for _, result := range results {
		if result.name == "fakePodASAT1" && (result.err != ErrorServiceAccountTokenDeprecated || result.dsa == "") {
...
func TestReplicationControllerASAT(t *testing.T) {
	...
	for _, result := range results {
		if result.name == "fakeReplicationControllerASAT1" && (result.err != ErrorServiceAccountTokenDeprecated || result.dsa == "") {
